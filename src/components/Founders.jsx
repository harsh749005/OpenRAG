...
const Founders = () => {
  return (
    <div className="w-[90%] h-max pb-2 md:w-[80%] md:h-[120vh] m-auto">
      <SpotlightCard
      ...
      >
        <div className=" ">
          <GradientText
            ...
            animationSpeed={3}
            showBorder={false}
            className="text-2xl  md:text-5xl text-left text-white p-2 sm:mt-0 md:text-center md:mt-40"
          >
            Book a 1-on-1 onboarding
          </GradientText>
       
          <p className="text-gray-300 mt-16">
        ...
        <div className=" flex-1 h-max relative p-12 md:flex hidden">
