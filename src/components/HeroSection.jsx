  ...
  return (
    <>
      <div className="relative h-max pb-10 md:overflow-hidden pt-5 md:pt-16 md:h-screen">
          <div className="absolute inset-0 md:w-full md:h-full overflow-hidden rotate-180 md:rotate-0 w-72 h-72 m-auto sm:top-[-80px]">
            <img src={glow} className="absolute md:top-[120px] w-[90%] h-[90%]" alt="" />
            <div className="absolute  inset-0 bg-gradient-to-t from-black via-black/50 w-full h-full to-transparent " />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 relative z-10">
            <div className="text-center flex flex-col gap-5">
              ...
              <p className="sm:text-[12px] md:text-xl text-gray-400 max-w-2xl mx-auto mb-8">
